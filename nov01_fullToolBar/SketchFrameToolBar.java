...
public class SketchFrameToolBar extends JFrame {
  ...
  public SketchFrameToolBar(String title) {
    ...
    JButton button1 = new JButton(openAction);                 // Create button
    button1.setBorder(BorderFactory.createRaisedBevelBorder());// Add button border
    toolBar.add(button1);
